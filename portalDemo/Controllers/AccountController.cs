...
namespace portalDemo.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        private static String accountSid = ConfigurationManager.AppSettings["AccountId"].ToString();
        private static String to = "15942854392";
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            var currentUserInfo = userManagementService.GetUser(domainModel);
            if (currentUserInfo == null)
            {
                return Json("userNotExist", JsonRequestBehavior.AllowGet);
            }
            else
            {
                var cookie = new HttpCookie("_formAuthInfo_", System.Web.Helpers.Json.Encode(currentUserInfo));
                cookie.Expires = DateTime.Now.AddHours(30);
        ...
        public ActionResult SendCode()
        {
            ...
            try
            {
                tmpSmsContent = HttpUtility.UrlEncode(smsContent, System.Text.Encoding.UTF8);
            }
            catch (Exception e)
            {
        ...
        public ActionResult LogOff()
        {
            ...
            Request.RequestContext.HttpContext.Response.Cookies["_formAuthInfo_"].Expires = DateTime.Now.AddMinutes(-1);
